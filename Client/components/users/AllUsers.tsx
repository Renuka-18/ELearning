...
const AllUsers:FC<Props> = ({isTeam}) => {
  ...
  const columns = [
    ...
    {field :"purchased", headerName:"Purchased Course", flex:.5},
  ...
  if (isTeam){
      ...
      newData && newData.forEach((item:any) => {
        rows.push({
          ...
          email: item.email,
          role: item.role,
          purchased: item.courses.length, // Assuming courses is an array
        ...
        isLoading ? (
          ...
          <Box m="20px">
            <div className="w-full flex justify-end">
              <div className={`${style.button} !w-[200px] dark:bg-[#57c7a3] !h-[35px] dark:border dark:border-[#ffffff6c]`}
              ...
              aria-describedby= "modal-modal-description">
                <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 outline-none">
                  ...
                  <div className="mt-4">
                    ...
                    <select name="" id="" className={`${style.input} !mt-6`}>
                      <option value="admin">Admin</option>
                      <option value="user">User</option>
                    </select>
                    <br/>
                    <div className={`${style.button} my-6 !h-[30px]`}
            ...
            open && (
              ...
              aria-describedby= "modal-modal-description">
                <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 outline-none">
                  ...
                  <div className={`${style.button} !w-[120px] h-[30px] bg-[#57c7a3]`}
                  onClick={() => setOpen(!open)}>
                    Cancel
                  </div>
                  <div className={`${style.button} !w-[120px] h-[30px] bg-[#d63f3f]`}
