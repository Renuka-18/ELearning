    ...
    return (
        <div>
            <div className="w-[90%] 800px:w-[90%] m-auto py-5">
                <div className="w-full flex felex-col-reverse 800px:flex-row">
                    <div className="w-full 800px:w-[65%] 800px:pr-5">
                        ...
                        <div>
                            ...
                            <p className="text-[18px] mt-[20px] whitespace-pre-line w-full overflow-hidden text-black dar:text-white">
                                {data.description}
                            </p>
                        </div>
                        <br />
                        ...
                        <div className="w-full">
                            <div className="800px:flex items-center">
                                ...
                                <h5 className='text-[25px] font-Poppins text-black dark:tect-white'>
                                ...
                                <div className="w-full pb-4 " key={index}>
                                    <div className="flex">
                                        ...
                                        <div className="hidden 800px:block pl-2">
                                            ...
                                            <small className='text-[#000000d1] dark:text-white-[#ffffff83]'>
                            ...
                            <div className="w-full 800px:[35%] relative">
                                ...
                                <div className="flex items-center">
                                    {isPurchased ? (
                                        <Link
                                            className={`${style.button} w-[180px] my-3 fint-Poppins cursor-pointer !bg-[crimson]`}
                                            href={`/course-access/${data._id}`}>
                                            Enter to Course
                                        </Link>
                                    ) : (
                                        <div className={`${style.button} w-[180px] my-3 fint-Poppins cursor-pointer !bg-[crimson]`}
                                            onClick={handleOrder}>
                                            Buy Now {data.price}$
                                        </div>
                                    )}
                                ...
                                <p className="pb-1 text-black dark:text-white">*Certificate Course Included</p>
